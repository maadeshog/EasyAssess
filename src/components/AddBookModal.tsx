        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 animate-fade-in">
          ...
          {step === 'success' ? (
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden rounded-[24px] sm:rounded-[40px] border border-noir-border/40 bg-zinc-950 shadow-2xl flex flex-col"
            >
              {/* Header */}
              <div className="flex items-center justify-between border-b border-noir-border/20 p-4 sm:p-8 shrink-0">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white">
                    <ShieldCheck size={12} />
                    {step === 'entry' ? '1. Submission' : '2. Automated Screening'}
                  </div>
                  <h2 className="font-serif text-xl sm:text-3xl font-bold text-white">
                    {step === 'entry' ? 'Add New Resource' : 'Smart Assessment'}
                  </h2>
                </div>
